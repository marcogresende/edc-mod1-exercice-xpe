  ...
  policy = <<EOF
{
    ...
    "Statement": [
        ...
        {
          "Action": "iam:PassRole",
          "Resource": ["arn:aws:iam::377000241855:role/EMR_DefaultRole",
                       "arn:aws:iam::377000241855:role/EMR_EC2_DefaultRole"],
          "Effect": "Allow"
        }
    ]
}
